...
var (
	DefaultABIS = map[Architecture][]string{
		Architecture_ARMEABI: []string{"armeabi-v7a", "armeabi"},
		Architecture_ARM64:   []string{"arm64-v8a", "arm64"},
		Architecture_X86:     []string{"x86", "x86"},
		Architecture_X86_64:  []string{"x86_64", "x86_64"},
	}
